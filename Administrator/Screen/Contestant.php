...
$sql = "SELECT c.contestantID, c.name AS contestant_name, cat.name AS category_name FROM contestant c JOIN category cat ON c.category_ID = cat.catergoryID";
                ...
                <?php if ($result->num_rows > 0):
                    ...
                    while ($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td>
                                <a href="editContestant.php?id=<?= $row['contestantID'] ?>">
                                ...
                                <a href="deleteContestant.php?id=<?= $row['contestantID'] ?>" onclick="return confirm('Are you sure?')">
