        ...
        <div class="modal-content ">
            ...
            <div class="modal-body">
                <form action="" class="d-flex flex-column gap-3">
                    ...
                    <div class="d-flex gap-2 w-100 flex-column">
                        <label for="">Choreography & Creativity - 35%</label>
                        <input type="number" placeholder="Choreography & Creativity" class="ps-2 w-100 form-control">
                    </div>
                    <div class="d-flex gap-2 w-100 flex-column">
                        <label for="">Execution & Synchronization - 30%</label>
                        <input type="number" placeholder="Execution & Synchronization" class="ps-2 w-100 form-control">
                    </div>
                    <div class="d-flex gap-2 w-100 flex-column">
                        <label for="">Stage Presence - 25%</label>
                        <input type="number" placeholder="Stage Presence" class="ps-2 w-100 form-control">
                    </div>
                    <div class="d-flex gap-2 w-100 flex-column">
                        <label for="">Custome & Visual Impact - 10%</label>
                        <input type="number" placeholder="Custome & Visual Impact" class="ps-2 w-100 form-control">
                    </div>
                </form>
            </div>
